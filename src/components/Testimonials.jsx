...
const Testimonials = () => {
  ...
  return (
    <div className="my-20 lg:my-[8vw]">
      ...
      <p className="testimonial-heading mt-4 lg:mt-[1.3vw] text-lg sm:text-xl lg:text-[1.5vw] text-center text-grow">
      ...
      <div className="overflow-hidden mt-10 lg:mt-[3vw]" ref={emblaRef}>
        <div className="flex">
          {testimonials.map((item, ind) => (
            ...
            >
              <div className="flex flex-col items-center text-center justify-center lg:p-[1.7vw] p-6 rounded-2xl lg:rounded-[1.5vw]  border border-accent bg-accent/20 scale-80 backdrop-blur-md shadow-lg hover:scale-90 transition-transform duration-300">
                <img
                  src={item.image}
                  alt={item.name}
                ...
                <p className="lg:text-[1.2vw] text-base tracking-wide text-grow mt-2 lg:mt-[.7vw]">
                  {item.feedback}
                </p>
              </div>
            </div>
